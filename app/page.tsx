...
export default function Home() {
  return (
    <main className="relative min-h-screen bg-zinc-950 text-zinc-50 selection:bg-cyan-300/30 selection:text-white">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <div className="text-sm font-semibold tracking-wide">Head Production</div>
          ...
          <nav className="hidden items-center gap-7 text-sm text-zinc-300 md:flex">
            ...
            <a href="#founders" className="hover:text-white">
              Founders
            </a>
          ...
          <a
            href="#contact"
            className="rounded-xl bg-gradient-to-r from-cyan-300 to-violet-300 px-4 py-2 text-sm font-semibold text-zinc-950 hover:from-cyan-200 hover:to-violet-200"
          >
            Start a Project
          </a>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-5 py-16 md:grid-cols-12 md:py-24">
          <div className="relative md:col-span-7">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
              <a
                href="#contact"
                className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-cyan-300 to-violet-300 px-5 py-3 text-sm font-semibold text-zinc-950 hover:from-cyan-200 hover:to-violet-200"
              >
                Discuss your event
              </a>
              <a
                href="#showreel"
                className="inline-flex items-center justify-center rounded-xl border border-white/20 bg-white/5 px-5 py-3 text-sm font-semibold text-white hover:border-cyan-200/50 hover:bg-white/10"
              >
                Watch showreel
              </a>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-5 pb-10 md:pb-16">
        ...
        <div className="mt-7 overflow-hidden rounded-3xl border border-white/10 bg-white/5">
          <div className="relative">
            ...
            <div className="flex w-[200%] animate-marquee-slow items-center gap-3 py-5">
              {[
                "NOVA STAGE",
                "ATLAS SUMMIT",
                "VERTEX ESPORTS",
                ...
                .map((name, i) => (
                  <div
                    key={`${name}-${i}`}
                    className="mx-1 flex h-12 items-center rounded-2xl border border-white/10 bg-zinc-950/30 px-5 text-xs font-semibold tracking-wide text-zinc-200"
                  >
                    {name}
                  </div>
                ))}
      ...
      {/* Industries */}
      <section id="industries" className="mx-auto max-w-6xl px-5 py-14 md:py-20">
      ...
      {/* Founders */}
      <section id="founders" className="mx-auto max-w-6xl px-5 py-14 md:py-20">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          {[
            ...
            <div key={idx} className="rounded-3xl border border-white/15 bg-white/5 p-6 backdrop-blur-xl">
      ...
      <section className="mx-auto max-w-6xl px-5 py-14 md:py-20">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-5">
          {[
            ...
            <div key={p.n} className="rounded-3xl border border-white/10 bg-white/5 p-5">
      ...
      <footer className="border-t border-white/10">
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-5 py-10 text-sm text-zinc-400 md:flex-row md:items-center md:justify-between">
